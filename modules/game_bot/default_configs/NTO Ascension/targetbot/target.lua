...
ui.status.left:setColor("red")
ui.status.right:setText("Off")
ui.status.right:setColor("blue")
ui.target.left:setText("Target:")
ui.target.left:setColor("red")
ui.target.right:setText("-")
ui.target.right:setColor("blue")
ui.config.left:setText("Config:")
ui.config.left:setColor("red")
ui.config.right:setColor("blue")
ui.config.right:setText("-")
ui.danger.left:setText("Danger:")
ui.danger.left:setColor("red")
ui.danger.right:setText("0")
ui.danger.right:setColor("blue")
