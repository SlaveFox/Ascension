...
MarketOffer.new = function(offerId, t, item, amount, price, playerName, itemName, state, premium, var)
  local offer = {
    id = {},
    type = nil,
    item = 0,
...
function MarketOffer:getPremium()
	if self.premium == 0 then
		return "Gold Coins"
	elseif self.premium == 1 then
		return "Premium Points"
	elseif self.premium == 2 then
